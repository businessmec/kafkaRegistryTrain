...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.echandens.kafka.model.Contact contact;
  @Deprecated public java.util.List<com.echandens.kafka.model.Score> scores;
   ...
   * @param rollNumber The new value for rollNumber
   ...
   */
  public Student(java.lang.CharSequence id, java.lang.Integer rollNumber, java.lang.CharSequence firstName, java.lang.CharSequence lastName, java.lang.CharSequence className, com.echandens.kafka.model.Contact contact, java.util.List<com.echandens.kafka.model.Score> scores) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: contact = (com.echandens.kafka.model.Contact)value$; break;
    case 6: scores = (java.util.List<com.echandens.kafka.model.Score>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return The value of the 'rollNumber' field.
   */
   ...
   */
  public com.echandens.kafka.model.Contact getContact() {
    return contact;
  }
   ...
   * @param value the value to set.
   */
  public void setContact(com.echandens.kafka.model.Contact value) {
    this.contact = value;
  }
   ...
   */
  public java.util.List<com.echandens.kafka.model.Score> getScores() {
    return scores;
  }
   ...
   * @param value the value to set.
   */
  public void setScores(java.util.List<com.echandens.kafka.model.Score> value) {
    this.scores = value;
  }
   ...
   */
  public static com.echandens.kafka.model.Student.Builder newBuilder() {
    return new com.echandens.kafka.model.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.echandens.kafka.model.Student.Builder newBuilder(com.echandens.kafka.model.Student.Builder other) {
    return new com.echandens.kafka.model.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.echandens.kafka.model.Student.Builder newBuilder(com.echandens.kafka.model.Student other) {
    return new com.echandens.kafka.model.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
    ...
    private com.echandens.kafka.model.Contact contact;
    private com.echandens.kafka.model.Contact.Builder contactBuilder;
    private java.util.List<com.echandens.kafka.model.Score> scores;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.echandens.kafka.model.Student.Builder other) {
      super(other);
      ...
      if (other.hasContactBuilder()) {
        this.contactBuilder = com.echandens.kafka.model.Contact.newBuilder(other.getContactBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.echandens.kafka.model.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setRollNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearRollNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setClassName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearClassName() {
      className = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setContact(com.echandens.kafka.model.Contact value) {
     ...
     * @return This builder.
     */
    public com.echandens.kafka.model.Contact.Builder getContactBuilder() {
      if (contactBuilder == null) {
        if (hasContact()) {
          setContactBuilder(com.echandens.kafka.model.Contact.newBuilder(contact));
        } else {
          setContactBuilder(com.echandens.kafka.model.Contact.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.echandens.kafka.model.Student.Builder setContactBuilder(com.echandens.kafka.model.Contact.Builder value) {
      clearContact();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearContact() {
      contact = null;
      contactBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder setScores(java.util.List<com.echandens.kafka.model.Score> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.echandens.kafka.model.Student.Builder clearScores() {
      scores = null;
    ...
    public Student build() {
      try {
        ...
        if (contactBuilder != null) {
          ...
          record.contact = fieldSetFlags()[5] ? this.contact : (com.echandens.kafka.model.Contact) defaultValue(fields()[5]);
        }
        record.scores = fieldSetFlags()[6] ? this.scores : (java.util.List<com.echandens.kafka.model.Score>) defaultValue(fields()[6]);
        return record;
